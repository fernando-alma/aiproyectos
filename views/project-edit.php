...
<head>
    ...
    <title>Editar Proyecto | AIWKND</title>
    <meta name="description" content="Edita la información de tu proyecto en AIWKND.">
...
<body>
    ...
    <main class="pf-page">
        <div class="pf-shell">
            ...
            <!-- Header -->
            <div class="pf-header">
                <a href="javascript:history.back()" class="pf-back-btn" id="backBtn">
                ...
                <h1 class="pf-title">Editar Proyecto</h1>
                <p class="pf-subtitle">Modifica la información de tu proyecto</p>
            </div>

            <!-- Form -->
            <form id="projectEditForm" class="glass-effect" style="border-radius: 20px; overflow: hidden;">
                <div class="pf-grid">
                    ...
                    <div class="pf-col">
                        ...
                        <div class="pf-group">
                            ...
                            <input type="text" id="title" name="title" class="pf-input" required>
                        </div>

                        <div class="pf-group">
                            <label class="pf-label" for="group_name">Nombre del Equipo</label>
                            <small class="pf-hint">El nombre de tu grupo de trabajo</small>
                        ...
                        <div class="pf-group">
                            ...
                            <small class="pf-hint">Sube una nueva imagen o mantén la actual</small>
                    ...
                    <div class="pf-col">
                        ...
                        <div class="pf-group">
                            <label class="pf-label" for="status">Estado del Proyecto</label>
                            <small class="pf-hint">Indica si el proyecto sigue en desarrollo</small>
